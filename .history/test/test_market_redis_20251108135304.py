...
# Add parent directory to path to import back-end modules
...
def test_market_redis_full():
    ...
    try:
        ...
        print(f"✓ Market created (auto-saved to Redis)")
        ...
        print(f"\n✓ Market populated and saved to Redis")
        ...
        if not loaded_market:
            print("✗ Failed to load market from Redis")
            return False
        ...
        if matches:
            print(f"\n✓ All data matches! Redis storage/retrieval working correctly.")
        else:
