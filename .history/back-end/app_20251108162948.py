...
set_user_wallet(123)
set_user_wallet(456)
set_market_totals(1000000.0, 50000.0)
...
print(set_market_totals(1000000.0, 50000.0))

# Add some prices to the history
print("\nUpdating Price History:")
print(add_price_to_history(2))
print(add_price_to_history(2.1))
print(add_price_to_history(2.5))
