...
def set_market_totals(marketID, total_usd, total_bc):
    with r.pipeline() as pipe:
        ...
        pipe.execute()
    result = {"success": True, "marketID": marketID, "total_usd": total_usd, "total_bc": total_bc}
...
def get_market_total(marketID, currency_type):
    ...
    return {"success": True, "marketID": marketID, "currency_type": currency_type, "total": r.get(key)}
...
def add_price_to_history(marketID, price):
    ...
    r.rpush(key, price)
    result = {"success": True, "marketID": marketID, "price": price}
...
print("Recent Prices:", get_price_history("1"))
