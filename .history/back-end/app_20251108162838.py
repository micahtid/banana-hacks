...
set_user_wallet(user_id=123, usd_amount=1000.0, banana_amount=50.0)
set_user_wallet(user_id=456, usd_amount=500.0, banana_amount=200.0)
...
print(buy_coins(user_id=123, num_coins=20, current_price=2.00))
# 2. Credit user 123 bananacoins
print(sell_coins(user_id=123, num_coins=20, current_price=2.00))
