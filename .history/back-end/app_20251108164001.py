...
def buy_coins(userID, num_coins, current_price, marketID = 1):
    ...
    new_total_usd = int(get_market_total(marketID,"usd")["total"]) - cost
    new_total_coins = int(get_market_total(marketID,"bc")["total"]) + num_coins
...
def sell_coins(userID, num_coins, current_price, marketID = 1):
    ...
    wallet_data["wallet_coins"] = int(wallet_data["wallet_coins"]) - num_coins
    new_total_usd = int(get_market_total(marketID,"usd")["total"]) + revenue
    new_total_coins = int(get_market_total(marketID,"bc")["total"]) - num_coins
    set_market_totals(marketID, new_total_usd, new_total_coins)
